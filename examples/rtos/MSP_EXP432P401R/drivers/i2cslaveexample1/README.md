...
* This example requires two MSP432 LaunchPads. MASTER (i2cmasterexample1)
is run on one board and SLAVE (i2cslaveexample1) is run on the other
...
actions:
    ...
    * Uses the I2CSlave driver to communicate with the I2C master.
